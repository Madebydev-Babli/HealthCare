...
export default function Signup() {
  ...
  const handleSignup = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!loginRes?.ok) {
        toast.info("Account created. Redirecting to login...");
      ...
      const errorMsg = "Unable to create your account right now.";
      setError(errorMsg);
        ...
        <div className="grid gap-0 md:grid-cols-2">
          <div className="hidden flex-col justify-between bg-gradient-to-br from-emerald-600 via-cyan-600 to-blue-700 p-8 text-white md:flex">
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm text-cyan-50/90">
                Join Healthcare and manage appointments, care plans, and
                professional records securely.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur-sm">
              ...
              <p className="mt-2 text-sm text-white">
                Choose how you want to use Healthcare.
              </p>
            </div>
          </div>
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-slate-500">
                    Manage your practice and patient schedules.
                  </p>
                </button>
              </div>
              ...
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3 pl-11 pr-11 text-slate-900 outline-none transition focus:border-cyan-500 focus:bg-white"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-2xl bg-cyan-600 px-4 py-3.5 text-base font-semibold text-white transition hover:bg-cyan-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
            ...
            <div className="mt-6 flex flex-col gap-3 text-sm text-slate-600 sm:flex-row sm:items-center sm:justify-between">
              <Link
                href="/auth/login"
                className="font-medium text-cyan-700 transition hover:text-cyan-600"
              >
